...
void merubah_data_item(itemgame mobile_legends[],int jumlah_item,int index_item){
    if (jumlah_item == 0) {
        ...
        if (index_item >= 0 && index_item <= jumlah_item){
            ...
            cout<<"item telah di update"<<endl;
        } else{
...
int main (){
    ...
    itemgame mobile_legends[20]{
        {"Winter Truncheon", "Tidak Bergerak Dan Tidak dapat Diserang", 1910},
        {"Blade of despair", "Meningkatkan Damage Jika Musuh Sekarat",3010},
        {"Immortality", "Hidup Kembali Setelah Mati", 2120},
